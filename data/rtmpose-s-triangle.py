...
# ------- HHL 修改数据集的目录路径  (最后要加/)  测试集也是在同个目录下用 val_coco.json
data_root = '/home/hehanlong/work/mmpose/data/yolov8/datasets/Triangle_215_Dataset/Triangle_215_Keypoint_coco/'


# ------- HHL 数据集的meta info都不写在文件中 直接参数传入 
# 三角板关键点检测数据集-元数据
dataset_info = {
...
# HHL --- 其他任务的 config文件  下面链接 !!!!!!!!!! 下面的都是根据 这个17关键点模型配置 来的，有S M X几个档位
